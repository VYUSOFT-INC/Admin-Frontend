...
import { LayersIcon, PayoutScheduleIcon, PercentIcon, PinIcon, SlidersIcon } from "@/components/icons/SettingsIcons";
 ...
 * node 1071:8766). All five destinations — "Commission Rates", "Payout Schedule", "Category
 * Management", "Platform Config", and "Pickup & Store" — link somewhere real now (see
 * `SETTINGS_SUB_NAV`). The non-interactive "Soon"-badge branch below is kept so a future sixth
 * sub-nav destination can drop in the same way each of these did, without ever linking to a route
