...
export const metadata: Metadata = {
  title: "Sign In — MIVYU Admin Console",
};
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gradient-to-b from-[#fff5f8] to-[#fff8f9] px-8 py-[139px]">
      ...
      <AuthCard className="z-10">
        ...
        <div className="flex w-full flex-col items-center gap-1 text-center">
          <h1 className="text-[26px] font-extrabold tracking-[-0.78px] text-ink">Sign in to continue</h1>
          <p className="text-sm text-gray-500">Secure access for internal operations and administration.</p>
        </div>

        <LoginForm />

        <p className="w-full text-center text-xs text-gray-500">MIVYU Internal — Authorized Access Only</p>
      </AuthCard>
    </div>
  );
}
